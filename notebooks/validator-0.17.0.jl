...
# ╔═╡ 88bfee45-f139-4efc-9175-853758aa8b5f
md"""
...
begin
	if isnothing(surfaceurn)
		...
		Markdown.parse(indexingaccuracy_html(r, surfaceurn, strict = false, height=textheight))
	end
...
begin
	if isnothing(surfaceurn)
		...
		HTML(orthographicvalidity_html(r, surfaceurn, strict = false))
	end
end
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "7b8da7ec66ed6cdeef8794a43a6bed78822ef623"
...
git-tree-sha1 = "dafb1e8e78e305ff68ba33f6b927047bc12c45d5"
...
git-tree-sha1 = "d44db623314f350aee521a2bff4399c6a436db12"
